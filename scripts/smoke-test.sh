...
#
# Options:
#   --target  <url>    RE runtime base URL  (default: http://localhost:5601)
#   --pe-target <url> PE runtime base URL  (default: http://localhost:5600)
...
RE_URL="http://localhost:5601"
PE_URL="http://localhost:5600"
SKIP_PE=0
SKIP_RE=0
VERBOSE=0
