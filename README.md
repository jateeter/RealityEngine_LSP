...
shape. The TypeScript prototype these replaced is deprecated and frozen —
retained as the behavioral reference for core RE/PE semantics, and superseded by
[`RealityEngine_Scala`](../RealityEngine_Scala) for active runtime reference
work.
